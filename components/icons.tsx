...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 5a3 3 0 1 0-5.993 1.003c.005.03.01.06.015.09v0a3 3 0 1 0 5.978-1.093Z" /><path d="M17 12a3 3 0 1 0-5.993 1.003c.005.03.01.06.015.09v0a3 3 0 1 0 5.978-1.093Z" /><path d="M12 19a3 3 0 1 0-5.993 1.003c.005.03.01.06.015.09v0a3 3 0 1 0 5.978-1.093Z" /><path d="M12 5a3 3 0 1 0 5.993 1.003c-.005.03-.01.06-.015.09v0a3 3 0 1 0-5.978-1.093Z" /><path d="M7 12a3 3 0 1 0-5.993 1.003c.005.03.01.06.015.09v0a3 3 0 1 0 5.978-1.093Z" /><path d="M12 5.5v13" /><path d="M16.5 12H22" /><path d="M11.5 12H2" /><path d="M12 12v7" />
  </svg>
);

export const HeartPulseIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" /><path d="M3.22 12H9.5l.7-1 2.1 4.4 2.1-4.4.7 1h6.28" />
  </svg>
);
